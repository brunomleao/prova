module.exports = {
  obterFaixas: function () {
    ...
    const faixa01 = { inicioFaixa: 0, fimFaixa: 1320.0, aliquota: 0.075 };
    const faixa02 = { inicioFaixa: 1320.02, fimFaixa: 2571.29, aliquota: 0.09 };
    const faixa03 = { inicioFaixa: 2571.3, fimFaixa: 3856.94, aliquota: 0.12 };
    const faixa04 = { inicioFaixa: 3856.95, fimFaixa: 7507.49, aliquota: 0.14 };
    const teto = { inicioFaixa: 7507.5, fimFaixa: 1000000, aliquota: -1 };
  ...
  calcularDescontoProgressivo: function (salarioBruto) {
    ...
    for (let i = 0; i < faixas.length; i++) {
      ...
      if (salarioBruto >= faixaAtual.fimFaixa) {
        ...
        const descontoFaixa = this.calcularDescontoResidual(
          salarioBruto,
          faixaAnterior,
          faixaAtual
        );
    ...
    let descontoINSS = descontoFaixas.reduce(
